                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="POST" action="{{route('book.store')}}" enctype="multipart/form-data">
                                    @csrf
                                   ...
                                   @endforeach
                                        ...
                                        <input type="hidden" name="book_status" value="1" class="form-control" >
