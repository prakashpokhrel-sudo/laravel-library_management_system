...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.25/js/jquery.dataTables.js"></script>
                            ...
                            <div class="card">
                              @if(Auth::guard('admin')->id())
                                <div class="card-header border-bottom">
                                  <a href="{{route('bookcategory.create')}}"> <button class="btn btn-success"> Add Books</button></a> 
                                </div>
                                @endif
  ...
  <form action="{{route('bookcategory.destroy',$row->id)}}" method="post">@csrf
    @method('DELETE')
...
<a href="{{route('bookcategory.edit',[$row->id])}}">
