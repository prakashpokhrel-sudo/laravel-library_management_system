                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header border-bottom">
                                  <a href="{{route('bookrequest.create')}}"> <button class="btn btn-success"> Add Book Request</button></a> 
                                </div>
...
<a href="{{route('bookrequest.edit',[$row->id])}}">
                     <button class="btn btn-info btn-sm"><span>Edit</span> </button>
                    
                    </a>

    @if(Auth::guard('admin')->id())
<a href="{{route('bookrequest.checkedit',[$row->id])}}">
                     <button class="btn btn-info btn-sm">Add Book </button>
