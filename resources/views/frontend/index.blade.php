               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        ...
                        <ul class="locat_icon">
                           <li> <a href="#"><img src="/frontend/icon/facebook.png"></a></li>
                           <li> <a href="#"><img src="/frontend/icon/Twitter.png"></a></li>
                           <li> <a href="#"><img src="/frontend/icon/linkedin.png"></a></li>
                           <li> <a href="#"><img src="/frontend/icon/instagram.png"></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="Library-box">
                        <figure><img src="/frontend/images/Library-.jpg" alt="#"/></figure>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="container">
            ...
            <div class="row box">
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                  <div class="book-box">
                     <figure><img src="/frontend/images/book-1.jpg" alt="img"/></figure>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="book-box">
                     <figure><img src="/frontend/images/book-2.jpg" alt="img"/></figure>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                  <div class="book-box">
